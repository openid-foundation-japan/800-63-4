...
8. 定期的なレビュータイミングと、プライバシー([セクション 5.1.2](sec5_ial.ja.md#PrivacyReqs) を参照）の更新の契機となる特定条件を含む、プライバシー影響の実施に関する CSP のポリシー。
